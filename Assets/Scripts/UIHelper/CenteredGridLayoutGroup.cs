    ...
    public class CenteredGridLayoutGroup : GridLayoutGroup
    {
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            else // Flexible
            {
                if (autoControlChildSize)
                {
                    ...
                    // Duy?t c?u hình t?i uu tôn tr?ng StartAxis
                    for (int i = 1; i <= m_Children.Count; i++)
                    {
                        ...
                        {
                            // Tie-breaker: Uu tiên l?p d?y tr?c chính (fill) mà không làm gi?m scale
                            if (startAxis == Axis.Horizontal)
                            {
                                // Uu tiên s? c?t l?n nh?t mà v?n fit chi?u r?ng ban d?u (không c?n thu nh? thêm)
                            ...
                            {
                                // Uu tiên s? hàng l?n nh?t mà v?n fit chi?u cao ban d?u
                ...
                {
                    // Logic Flexible m?c d?nh: S? d?ng t?i da dung lu?ng có th? ch?a thay vì gi?i h?n theo s? item
                    if (startAxis == Axis.Horizontal)
                    {
            ...
            // Tính scale cho ch? d? Constraint Fixed
            ...
            // Khi không centerGrid, ta tính kích thu?c th?c t? d?a theo s? lu?ng item hi?n có
            // d? logic baseOffsetX/Y c?a Unity (childAlignment) ho?t d?ng dúng nhu Grid layout chu?n.
            ...
            // Can ch?nh toàn b? "Khung Grid" (Grid Block) d?a trên Child Alignment chu?n c?a Unity
            ...
            for (int i = 0; i < m_Children.Count; i++)
            {
                ...
                // Tính toán v? trí visual d?a trên corner
        ...
        public class CenteredGridLayoutGroupEditor : Editor
        {
            ...
            public override void OnInspectorGUI() {
                ...
                // V? các thu?c tính co b?n c?a GridLayoutGroup
                ...
                // ?n Constraint Count n?u là Flexible
                ...
                if (m_CenterGrid.boolValue)
                {
                    ...
                    EditorGUILayout.HelpBox("S? d?ng 'Child Alignment' phía trên d? can l? cho TOÀN B? khung Grid.", MessageType.Info);
                }
